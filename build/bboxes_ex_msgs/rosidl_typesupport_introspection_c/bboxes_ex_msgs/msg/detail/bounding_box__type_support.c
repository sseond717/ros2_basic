...
static rosidl_typesupport_introspection_c__MessageMember bboxes_ex_msgs__msg__BoundingBox__rosidl_typesupport_introspection_c__BoundingBox_message_member_array[10] = {
  {
    "probability",  // name
