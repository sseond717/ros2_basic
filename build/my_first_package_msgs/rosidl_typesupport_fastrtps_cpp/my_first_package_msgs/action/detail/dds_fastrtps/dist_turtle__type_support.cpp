...
{
bool cdr_serialize(
  const my_first_package_msgs::action::DistTurtle_Goal &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const my_first_package_msgs::action::DistTurtle_Result &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const my_first_package_msgs::action::DistTurtle_Feedback &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
